...
public:
    ...
    __host__ __device__ MaterialTypeID getTypeID() const override { return MaterialTypeID::materialDiffuseSpotLightType; }
...
__device__ color diffuse_spot_light::emitted(const ray& r_in, const hit_record& rec, float u, float v, const point3& p, curandState* local_rand_state) const
{
