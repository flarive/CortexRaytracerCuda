...
__host__ __device__ inline gradient_texture::gradient_texture()
{
}

__host__ __device__ inline gradient_texture::gradient_texture(color c1, color c2, bool v, bool hsv2) : aligned_v(v)
{
...
__host__ __device__ inline color gradient_texture::value(float u, float v, const point3& p) const
{
