...
namespace rt
{
    ...
    public:
        ...
        __host__ __device__ virtual HittableTypeID getTypeID() const { return HittableTypeID::hittableTransformFlipNormalType; }
...
__device__ bool rt::flip_normals::hit(const ray& r, interval ray_t, hit_record& rec, int depth, curandState* local_rand_state) const
{
    if (m_object->hit(r, ray_t, rec, depth, local_rand_state))
    {
