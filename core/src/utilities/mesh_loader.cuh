...
//        model_output.add(new bvh_node(shape_triangles, name));
//    }
//
...
//    return new bvh_node(model_output, 0, model_output.object_count, local_rand_state, name);
//}
//
///// <summary>
...
//    texture* transparency_a = new solid_color_texture(get_color((tinyobj::real_t*)reader_mat.transmittance) * (1. - reader_mat.dissolve));
