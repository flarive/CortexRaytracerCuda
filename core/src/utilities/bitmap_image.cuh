...
public:
    ...
    __host__ __device__ bitmap_image(unsigned char* data, const int width, const int height, const int channels) : m_data(data), m_image_width(width), m_image_height(height), m_image_channels(channels)
    {
    }
